...
const CONFIGS: CreativeConfig[] = [
...

  {
    ...
    promptBlocks: [
      ...
      BLOCKS.productContext(),
      BLOCKS.continuity(),
      BLOCKS.scene('Premium ad packshot: product floats mid-frame with dynamic splash and glow particles radiating outward. Hero shot vibe for paid social ad.'),
      BLOCKS.composition('Product centered, negative space around for copy overlay. Splash + particles tasteful, never cluttered.'),
      BLOCKS.lighting('Dramatic rim light + soft fill. Brand-accent gradient background. Subtle particles catching light.'),
      BLOCKS.camera('Tripod studio, eye-level, slight 3/4 angle for dimensionality.'),
      BLOCKS.platform('facebook-ads'),
      BLOCKS.variation(),
      BLOCKS.localeHardLock(),
      BLOCKS.negative(['realistic environmental scene', 'flat lighting', 'cluttered splash']),
    ],
...

  {
    ...
    promptBlocks: [
      ...
      BLOCKS.productContext(),
      BLOCKS.continuity(),
      BLOCKS.scene('Product as centered hero on a natural surface (wood / linen / stone), surrounded by a tasteful arrangement of its key ingredients — herbs, leaves, dried botanicals, raw extracts.'),
      BLOCKS.composition('Editorial flat-lay or slight 3/4 elevation. Ingredients radiate around product as supporting players, never overwhelming.'),
      BLOCKS.lighting('Soft directional daylight. Shallow depth of field — product sharp, ingredients soft.'),
      BLOCKS.camera('Tripod, slight 3/4 elevation, head-on.'),
      BLOCKS.platform('instagram-feed'),
      BLOCKS.variation(),
      BLOCKS.localeHardLock(),
...

  {
    ...
    promptBlocks: [
      ...
      BLOCKS.productContext(),
      BLOCKS.continuity(),
      BLOCKS.scene('Group of 3-5 people (friends, family, or coworkers) standing close together, all holding or showing the same product. Authentic natural smiles, candid moment.'),
      BLOCKS.composition('Group naturally arranged — slight overlap, candid gathering, not lineup. Product clearly visible across the group.'),
      BLOCKS.lighting('Soft natural daylight, indoor casual setting.'),
      BLOCKS.camera('Handheld smartphone, eye-level, casual framing.'),
      BLOCKS.ugc('Real group dynamics. Culturally believable for SEA market. Not stock-photo posed.'),
      BLOCKS.platform('landing-page'),
      BLOCKS.variation(),
      BLOCKS.localeHardLock(),
      BLOCKS.negative(['stock-photo lineup', 'model-portfolio uniformity', 'studio backdrop']),
    ],
...

  {
    ...
    promptBlocks: [
      ...
      BLOCKS.productContext(),
      BLOCKS.continuity(),
      BLOCKS.scene('A FICTIONAL professional spokesperson — doctor / pharmacist / nutritionist / wellness expert as fits the product niche — presenting or holding the product. Clean professional setting. NEVER impersonate a real person.'),
      BLOCKS.composition('Expert as the centered subject, product visible in hand or on surface beside them. Negative space for headline copy overlay if needed.'),
      BLOCKS.emotion('Direct calm eye contact. Authoritative but warm. Genuine professional expression.'),
      BLOCKS.lighting('Clean professional lighting, soft fill, balanced.'),
      BLOCKS.camera('Tripod, head-on eye-level, slight 3/4 angle.'),
      BLOCKS.platform('landing-page'),
      BLOCKS.variation(),
      BLOCKS.localeHardLock(),
      BLOCKS.negative(['impersonating real doctors / celebrities / KOLs', 'fake credentials in frame', 'sterile clinical', 'cartoonish stock-photo expert']),
    ],
...

  {
    ...
    promptBlocks: [
      ...
      BLOCKS.productContext(),
      BLOCKS.continuity(),
      BLOCKS.composition('2×2 grid composition — 4 equal cells separated by thin clean white gutter lines. Each cell shows a DIFFERENT person holding the same product. Layout cohesive as a testimonial collage.'),
      BLOCKS.scene('Four different SEA people (varied age, gender, look) — each in their own cell of a 4-grid — all holding the SAME product. Identical lighting + background tone across cells. Authentic natural expressions in every cell.'),
      BLOCKS.lighting('Soft natural daylight, evenly matched across all 4 cells.'),
      BLOCKS.camera('Handheld smartphone aesthetic per cell — consistent framing distance across cells.'),
      BLOCKS.ugc('Real diverse humans — NOT stock-photo posed. Culturally believable for SEA. Different people in every cell, never repeated.'),
      BLOCKS.platform('landing-page'),
      BLOCKS.variation(),
      BLOCKS.localeHardLock(),
      BLOCKS.negative([
