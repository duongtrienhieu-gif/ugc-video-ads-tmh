...
4b. speaker = nhân vật THỰC SỰ THỐT ra câu thoại đó (đọc POV "tui/tôi/tao" là AI) — phải COPY Y NGUYÊN 1 name trong "characters" (để map đúng GIỌNG). Cảnh HERO tự giới thiệu / ra đòn / khoe cơ chế ("để đó tôi lo", "3 lò xo này sẽ…") → speaker = HERO. Cảnh organ/villain cảm nhận/kể/cằn nhằn ("vết nứt của tui", "tao tan rồi") → speaker = organ/villain. KHÔNG mặc định mọi cảnh về 1 người dẫn — ai nói câu đó thì người ấy là speaker.
